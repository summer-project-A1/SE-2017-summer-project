...
<div class="products">
    ...
    <div class="container">
            ...
            <section class="sky-form">
                <div class="product_right">
                    ...
                    <div class="tab1">
                        ...
                        <div class="clearfix"> </div>
                        <div class="single-bottom">
                            <a id="show-exchange-book-list" href="#"><p>尚未完成的交换</p></a>
                            <a id="show-exchange-book-history-list" href="#"><p>已完成的交换</p></a>
                        </div>
                    </div>
                    <div class="tab1">
                        <ul class="place">
        ...
        <div id="cartinfo" class="cart-item">
            <div class="container">
                <!-- 以下迭代显示尚未完成的交换 -->
                <div id="exchange-book-list">
                    <h4>尚未完成的交换</h4>
                    <!-- 己方发起的交换 -->
                    <s:iterator value="#activeExchange" status="map_state">
                    <div id="exchangeBook<s:property value="exchangeID"/>" class="cart-header">
                        <div class="cart-sec simpleCart_shelfItem">
                            <div class="cart-item-info">
                                <h4>
                                    <a href="<%=path%>/bookAction/showBookProfile?bookID=<s:property value="wantedBookID"/>">换入的书：<s:property value="wantedBook.bookName"/></a><br>
                                    <a href="<%=path%>/bookAction/showBookProfile?bookID=<s:property value="hadBookID"/>">换出的书：<s:property value="hadBook.bookName"/></a><br>
                                    <span id="status<s:property value="exchangeID"/>">当前状态：
                                        <s:if test="exchangeStatus=='WAITING'">等待对方确认</s:if>
                                        <s:elseif test="exchangeStatus=='AGREED'">买家未付款</s:elseif>
                                        <s:elseif test="exchangeStatus=='REJECTED'">对方已拒绝</s:elseif>
                                        <s:elseif test="exchangeStatus=='CANCELED'">交换已取消</s:elseif>
                                        <s:elseif test="exchangeStatus=='COMPLETED'">交换已完成</s:elseif>
                                    </span>
                                </h4>
                                <!--
                                <ul class="qty">
                                ...
                                <div class="delivery">
                                    ...
                                    <s:elseif test="borrowStatus=='AGREED'">
                                        <p id="orderDate<s:property value="borrowID"/>">下单日期：<s:property value="orderDate"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
